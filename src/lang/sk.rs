...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Access details for support", "Prístupové údaje pre podporu"),
        ("datasoftware_support_credentials_tip", "Pošlite toto ID a heslo technickej podpore DataSoftware. Heslo je trvalé a už sa znova nezobrazí."),
        ("datasoftware_id_pending", "ID sa ešte priraďuje, nájdete ho v hlavnom okne."),
        ("Copy both", "Kopírovať oboje"),
        ("I have sent these details", "Údaje som odoslal"),
        ("Copy", "Kopírovať"),
    ].iter().cloned().collect();
}
